...
## Introduktion
# TODO: Vi starter med at fjerne alle variabler
# TODO: der måtte være i vores workspace.
# I denne Matlab(Python)-fil skal vi lave en
# animation af jordens rotation omkring
# sig selv. Vi modellerer Jorden som
# en kugle med radius 1 og med centrum i
# Origo.
